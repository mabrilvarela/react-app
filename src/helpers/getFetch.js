const productos = [
    ...
    {id: '2', categoria: 'perros', nombre: 'Active Mind 7+ Razas Medianas y Grandes', precio: 9790, kg: '15 kg', descripcion: 'Provee nutrición de avanzada para proteger a los perros mayores de 7 años, manteniéndolos sanos y activos. Formulado con fuentes naturales de glucosamina, que ayudan a mantener las articulaciones sanas y una movilidad óptima. Contiene una proporción equilibrada de proteína y grasa para mantener la masa muscular magra, una combinación de antioxidantes naturales y vitaminas E y C.', img: 'https://www.purina-latam.com/sites/g/files/auxxlc391/files/styles/kraken_generic_max_width_360/public/purina-pro-plan-flagship-perros-active-mind-razas-medianas-y-grandes.png?itok=IQrn1_wh'},
